...
realms:
  ...
  - name: fluidRealm
    ...
    # Boundary conditions are periodic on the east-west and north-south sides.
    # The lower boundary condition is a slip wall.  The upper boundary 
    ...
    output:
      output_data_base_name: ablHill3d_pp.e
      output_frequency: 1
      output_nodse_set: no
      output_variables:
       - velocity
    ...
    restart:
      restart_data_base_name: ablHill3d_pp.rst
#      restart_time: 0.4

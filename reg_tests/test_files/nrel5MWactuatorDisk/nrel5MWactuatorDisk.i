...
realms:
  ...
  - name: realm_1
    ...
    output:
      output_data_base_name: actuatorDisk.e
      output_frequency: 1
      output_node_set: no
      output_variables:
       - velocity
    ...
    restart:
      restart_data_base_name: actuatorDisk.rst
...
Time_Integrators:
  - StandardTimeIntegrator:
      name: ti_1
      start_time: 0
      termination_step_count: 5 # reduced time step until performance addressed
      time_step: 0.0625

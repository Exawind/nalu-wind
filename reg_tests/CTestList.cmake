...
macro(setup_test testname np)
  ...
  set(MPI_COMMAND "${MPI_PREAMBLE} ${CMAKE_BINARY_DIR}/${kynema-ugf_ex_name} ${MPIEXEC_POSTFLAGS}")
...
#        setup_test(${testname} ${np})
#        add_test(${testname} sh -c "${MPI_PREAMBLE} ${CMAKE_BINARY_DIR}/${kynema-ugf_ex_catalyst_name} ${MPIEXEC_POSTFLAGS} -i ${CMAKE_CURRENT_BINARY_DIR}/test_files/${testname}/${testname}_catalyst.yaml -o ${testname}.log && ${CMAKE_CURRENT_SOURCE_DIR}/pass_fail_catalyst.sh ${testname} ${ncat}")
#        set_properties(${testname})
...
if(NOT ENABLE_CUDA AND NOT ENABLE_ROCM)
  ...
  if(ENABLE_HYPRE)
    ...
    add_test_r(IDDESPeriodicHillEdge 8)
    add_test_r(IDDESTransPeriodicHillEdge 8)
  ...
  if(ENABLE_HYPRE)
    ...
    add_test_r(airfoilSST_Gamma_Trans 2)
    add_test_r(IDDESPeriodicHillEdge 2)
    add_test_r(IDDESTransPeriodicHillEdge 2)
  endif()

...
macro(setup_test testname np)
  ...
  set(COMPARE_GOLDS_COMMAND_NC " && ${CMAKE_CURRENT_SOURCE_DIR}/test_files/${testname}/passfail")
  set(CHECK_SOL_NORMS_COMMAND " && python3 ${CMAKE_CURRENT_SOURCE_DIR}/test_files/${testname}/check_sol_norms.py ${testname} ${NALU_WIND_REFERENCE_GOLDS_DIR}/${testname}/${testname}.norm.gold --abs-tol ${ABS_TOLERANCE}")

...
/**
 * @brief This is the interface class for running all the kokkos based actuator models
 *
 * This interface class should handle the logic for construction and execution of the 
 * underlying models at the highest abstraction levels possible  
 * since we only allow one actuator section per input file we can consider it a singelton
 */

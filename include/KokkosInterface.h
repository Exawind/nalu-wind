...
{
  return Kokkos::subview(SharedMemView<T**,TeamShmemType>(team.team_shmem(), team.team_size(), len), team.team_rank(), Kokkos::ALL());
}
...
{
  return Kokkos::subview(SharedMemView<T***,TeamShmemType>(team.team_shmem(), team.team_size(), len1, len2), team.team_rank(), Kokkos::ALL(), Kokkos::ALL());
}
...
{
  return Kokkos::subview(SharedMemView<T****,TeamShmemType>(team.team_shmem(), team.team_size(), len1, len2, len3), team.team_rank(), Kokkos::ALL(), Kokkos::ALL(), Kokkos::ALL());
}
...
{
  return Kokkos::subview(SharedMemView<T*****,TeamShmemType>(team.team_shmem(), team.team_size(), len1, len2, len3, len4), team.team_rank(), Kokkos::ALL(), Kokkos::ALL(), Kokkos::ALL());
}
...
{
  return Kokkos::subview(SharedMemView<T******,TeamShmemType>(team.team_shmem(), team.team_size(), len1, len2, len3, len4, len5), team.team_rank(), Kokkos::ALL(), Kokkos::ALL(), Kokkos::ALL());
}

...
public:
  ...
  KOKKOS_DEFAULTED_FUNCTION TurbKineticEnergyKsgsDesignOrderSrcElemKernel() = default;

  KOKKOS_DEFAULTED_FUNCTION virtual ~TurbKineticEnergyKsgsDesignOrderSrcElemKernel() = default;

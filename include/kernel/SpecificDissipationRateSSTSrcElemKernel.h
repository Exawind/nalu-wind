...
public:
  ...
  KOKKOS_DEFAULTED_FUNCTION SpecificDissipationRateSSTSrcElemKernel() = default;

  KOKKOS_DEFAULTED_FUNCTION virtual ~SpecificDissipationRateSSTSrcElemKernel() = default;

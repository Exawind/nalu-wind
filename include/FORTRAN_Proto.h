...
extern "C" void SIERRA_FORTRAN(hex_scs_det)(
  const int* nelem,
  const int* npe,
  const int* nscs,
  const double* coords,
...
extern "C" void SIERRA_FORTRAN(hex_scv_det)(
  const int* nelem,
  const int* npe,
  const int* nscv,
  const double* coords,
...
extern "C" void SIERRA_FORTRAN(tet_scv_det)(
  const int* nelem,
  const int* npe,
  const int* nscv,
  const double* coords,
...
extern "C" void SIERRA_FORTRAN(tet_scs_det)(
  const int* nelem,
  const int* npe,
  const int* nscs,
  const double* coords,
...
extern "C" void SIERRA_FORTRAN(pyr_scs_det)(
  const int* nelem,
  const int* npe,
  const int* nscs,
  const double* coords,
...
extern "C" void SIERRA_FORTRAN(pyr_scv_det)(
  const int* nelem,
  const int* npe,
  const int* nscv,
  const double* coords,
...
extern "C" void SIERRA_FORTRAN(wed_scs_det)(
  const int* nelem,
  const int* npe,
  const int* nscs,
  const double* coords,
...
extern "C" void SIERRA_FORTRAN(wed_scv_det)(
  const int* nelem,
  const int* npe,
  const int* nscv,
  const double* coords,
...
extern "C" void SIERRA_FORTRAN(tri_scs_det)(
  const int* nelem,
  const int* npe,
  const int* nscs,
  const double* coords,
...
extern "C" void SIERRA_FORTRAN(tri_scv_det)(
  const int* nelem,
  const int* npe,
  const int* nscv,
  const double* coords,
...
extern "C" void SIERRA_FORTRAN(quad_scs_det)(
  const int* nelem,
  const int* npe,
  const int* nscs,
  const double* coords,
...
extern "C" void SIERRA_FORTRAN(quad_scv_det)(
  const int* nelem,
  const int* npe,
  const int* nscv,
  const double* coords,
...
extern "C" void SIERRA_FORTRAN(quad3d_scs_det)(
  const int* nelem, const double* coords, double* areav);

extern "C" void SIERRA_FORTRAN(tri3d_scs_det)(
  const int* nelem,
  const int* npe,
  const int* nint,
  const double* coords,
...
extern "C" void SIERRA_FORTRAN(edge2d_scs_det)(
  const int* nelem,
  const int* npe,
  const int* nint,
  const double* coords,

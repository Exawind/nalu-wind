...
#ifndef TKEKONODEKERNEL_H
#define TKEKONODEKERNEL_H
...
class TKEKONodeKernel : public NGPNodeKernel<TKEKONodeKernel>
{
public:
  TKEKONodeKernel(const stk::mesh::MetaData&);

  TKEKONodeKernel() = delete;

  KOKKOS_DEFAULTED_FUNCTION
  virtual ~TKEKONodeKernel() = default;

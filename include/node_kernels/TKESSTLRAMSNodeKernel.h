...
#ifndef TKESSTLRAMSNODEKERNEL_H
#define TKESSTLRAMSNODEKERNEL_H
...
class TKESSTLRAMSNodeKernel : public NGPNodeKernel<TKESSTLRAMSNodeKernel>
{
public:
  TKESSTLRAMSNodeKernel(const stk::mesh::MetaData&, const std::string);

  TKESSTLRAMSNodeKernel() = delete;

  KOKKOS_DEFAULTED_FUNCTION
  virtual ~TKESSTLRAMSNodeKernel() = default;

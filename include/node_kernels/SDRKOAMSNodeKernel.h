...
class SDRKOAMSNodeKernel : public NGPNodeKernel<SDRKOAMSNodeKernel>
{
public:
  SDRKOAMSNodeKernel(const stk::mesh::MetaData&);

  SDRKOAMSNodeKernel() = delete;

  KOKKOS_DEFAULTED_FUNCTION
  virtual ~SDRKOAMSNodeKernel() = default;

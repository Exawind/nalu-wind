...
#ifndef SDRSSTLRAMSNODEKERNEL_H
#define SDRSSTLRAMSNODEKERNEL_H
...
class SDRSSTLRAMSNodeKernel : public NGPNodeKernel<SDRSSTLRAMSNodeKernel>
{
public:
  SDRSSTLRAMSNodeKernel(const stk::mesh::MetaData&, const std::string);

  SDRSSTLRAMSNodeKernel() = delete;

  KOKKOS_DEFAULTED_FUNCTION
  virtual ~SDRSSTLRAMSNodeKernel() = default;

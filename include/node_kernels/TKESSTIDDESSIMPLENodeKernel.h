...
// for more details.
#ifndef TKESSTIDDESSIMPLENODEKERNEL_H
#define TKESSTIDDESSIMPLENODEKERNEL_H
...
class TKESSTIDDESSIMPLENodeKernel
  : public NGPNodeKernel<TKESSTIDDESSIMPLENodeKernel>
{
public:
  TKESSTIDDESSIMPLENodeKernel(const stk::mesh::MetaData&);

  TKESSTIDDESSIMPLENodeKernel() = delete;

  KOKKOS_DEFAULTED_FUNCTION
  virtual ~TKESSTIDDESSIMPLENodeKernel() = default;
...
#endif /* TKESSTIDDESSIMPLENODEKERNEL_H */

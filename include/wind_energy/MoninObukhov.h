...
psim_stable(const T& zeta, const T beta = 5.0)
{
  return (-beta * zeta);
}
...
template <typename T>
KOKKOS_FORCEINLINE_FUNCTION T
psih_stable(const T& zeta, const T beta = 5.0)
{
  return (-beta * zeta);
}
...
template <typename T>
KOKKOS_FORCEINLINE_FUNCTION T
psim_unstable(const T& zeta, const T gamma = 16.0)
{
...
template <typename T>
KOKKOS_FORCEINLINE_FUNCTION T
psih_unstable(const T& zeta, const T gamma = 16.0)
{
  // Actually (1.0 / phih)

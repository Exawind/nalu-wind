...
public:
  ...
  void scs_xhat_grad(const nodal_scalar_view& f, nodal_vector_view& grad) const
  {
    ...
    tensor_internal::apply_y<p, Scalar, p, n, n>(
      mat_.nodalDeriv, scratch, grad, YH);
    tensor_internal::apply_z<p, Scalar, p, n, n>(
      mat_.nodalDeriv, scratch, grad, ZH);
  }
  ...
  void scs_yhat_grad(const nodal_scalar_view& f, nodal_vector_view& grad) const
  {
    ...
    tensor_internal::apply_x<p, Scalar, n, p, n>(
      mat_.nodalDeriv, scratch, grad, XH);
    tensor_internal::apply_y<p, Scalar, n, p, n>(mat_.scsDeriv, f, grad, YH);
    tensor_internal::apply_z<p, Scalar, n, p, n>(
      mat_.nodalDeriv, scratch, grad, ZH);
  }
  ...
  void scs_zhat_grad(const nodal_scalar_view& f, nodal_vector_view& grad) const
  {
    ...
    tensor_internal::apply_x<p, Scalar, n, n, p>(
      mat_.nodalDeriv, scratch, grad, XH);
    tensor_internal::apply_y<p, Scalar, n, n, p>(
      mat_.nodalDeriv, scratch, grad, YH);
  ...
  void volume(const nodal_scalar_view& f, nodal_scalar_view& f_bar) const
  {
    ...
    tensor_internal::apply_x<p, Scalar, n, n, n>(
      mat_.nodalWeights, f, scratch_1);

    nodal_scalar_workview work_scratch_2;
    auto& scratch_2 = work_scratch_2.view();

    tensor_internal::apply_y<p, Scalar, n, n, n>(
      mat_.nodalWeights, scratch_1, scratch_2);
    tensor_internal::apply_z<p, Scalar, n, n, n>(
      mat_.nodalWeights, scratch_2, scratch_1);
  ...
  void integrate_and_diff_xhat(
    const nodal_scalar_view& f, nodal_scalar_view& f_bar) const
  {
    nodal_scalar_workview work_scratch_1;
    auto& scratch_1 = work_scratch_1.view();
    tensor_internal::apply_y<p, Scalar, n, n, n>(
  ...
  void integrate_and_diff_xhat(
    const nodal_vector_view& f, nodal_vector_view& f_bar) const
  {
    nodal_vector_workview work_scratch_1;
    auto& scratch_1 = work_scratch_1.view();
    tensor_internal::apply_y<p, Scalar, n, n, n>(

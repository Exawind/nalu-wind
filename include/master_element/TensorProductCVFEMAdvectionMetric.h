  ...
  for (int k = 0; k < p + 1; ++k) {
    for (int j = 0; j < p + 1; ++j) {
      for (int i = 0; i < p + 1; ++i) {
        ...
        for (int d = 0; d < 3; ++d) {
          rhou_corr(k, j, i, d) =
            rho * velocity(k, j, i, d) +
            projTimeScale * proj_pressure_gradient(k, j, i, d);
        }
      }
    }
  }
  ...
  for (int k = 0; k < p + 1; ++k) {
    ...
    for (int j = 0; j < p + 1; ++j) {
      ...
      for (int i = 0; i < p; ++i) {
        ...
        const auto dpdxIp_dot_A =
          laplacian_metric(XH, k, j, i, XH) * dpdxhIp(k, j, i, XH) +
  ...
  for (int k = 0; k < p + 1; ++k) {
    ...
    for (int j = 0; j < p; ++j) {
      ...
      for (int i = 0; i < p + 1; ++i) {
        ...
        const auto dpdxIp_dot_A =
          laplacian_metric(YH, k, j, i, XH) * dpdxhIp(k, j, i, XH) +
  ...
  for (int k = 0; k < p; ++k) {
    ...
    for (int j = 0; j < p + 1; ++j) {
      ...
      for (int i = 0; i < p + 1; ++i) {
        ...
        const auto dpdxIp_dot_A =
          laplacian_metric(ZH, k, j, i, XH) * dpdxhIp(k, j, i, XH) +

...
using ScalarNodalGradBndryElemAlg = NodalGradBndryElemAlg<
  ...
  ScalarFieldType,
  VectorFieldType,
  kynema-ugf_ngp::ScalarViewHelper<NodalGradBndryElemSimdDataType, ScalarFieldType>>;
...
using VectorNodalGradBndryElemAlg = NodalGradBndryElemAlg<
  ...
  VectorFieldType,
  GenericFieldType,
  kynema-ugf_ngp::VectorViewHelper<NodalGradBndryElemSimdDataType, VectorFieldType>>;

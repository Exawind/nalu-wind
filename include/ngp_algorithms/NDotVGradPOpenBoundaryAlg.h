...
#ifndef NDOTVGRADPOPENBOUNDARYALG_H
#define NDOTVGRADPOPENBOUNDARYALG_H
...
class NDotVGradPOpenBoundary : public Algorithm
{
public:
  NDotVGradPOpenBoundary(
    Realm &,
    stk::mesh::Part *,
    const bool useShifted);

  virtual ~NDotVGradPOpenBoundary() = default;

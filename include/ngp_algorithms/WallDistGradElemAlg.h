...
#ifndef WALLDISTGRADELEMALG_H
#define WALLDISTGRADELEMALG_H
...
class WallDistGradElemAlg : public Algorithm
{
  static_assert(
...
public:
  ...
  virtual ~WallDistGradElemAlg() = default;
...
using ScalarWallDistGradElemAlg =
  WallDistGradElemAlg<AlgTraits, ScalarFieldType, VectorFieldType>;

template<typename AlgTraits>
using VectorWallDistGradElemAlg =
  WallDistGradElemAlg<AlgTraits,VectorFieldType, GenericFieldType>;

}  // nalu
}  // sierra


#endif /* WALLDISTGRADELEMALG_H */

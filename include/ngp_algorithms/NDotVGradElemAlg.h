...
#ifndef NDOTVGRADELEMALG_H
#define NDOTVGRADELEMALG_H
...
class NDotVGradElemAlg : public Algorithm
{
  static_assert(
...
public:
  ...
  virtual ~NDotVGradElemAlg() = default;
...
using ScalarNDotVGradElemAlg =
  NDotVGradElemAlg<AlgTraits, ScalarFieldType, VectorFieldType>;

template<typename AlgTraits>
using VectorNDotVGradElemAlg =
  NDotVGradElemAlg<AlgTraits,VectorFieldType, GenericFieldType>;

}  // nalu
}  // sierra


#endif /* NDOTVGRADELEMALG_H */

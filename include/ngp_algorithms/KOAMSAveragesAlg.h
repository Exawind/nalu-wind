...
#ifndef KOAMSAveragesAlg_h
#define KOAMSAveragesAlg_h
...
class KOAMSAveragesAlg : public AMSAveragesAlg
{
public:
  using DblType = double;

  KOAMSAveragesAlg(Realm& realm, stk::mesh::Part* part);

  virtual ~KOAMSAveragesAlg() = default;

...
#ifndef NDOTVGRADBNDRYELEMALG_H
#define NDOTVGRADBNDRYELEMALG_H
...
class NDotVGradBndryElemAlg : public Algorithm
{
  static_assert(
...
public:
  ...
  virtual ~NDotVGradBndryElemAlg() = default;
...
using ScalarNDotVGradBndryElemAlg =
  NDotVGradBndryElemAlg<AlgTraits, ScalarFieldType, VectorFieldType>;

template<typename AlgTraits>
using VectorNDotVGradBndryElemAlg =
  NDotVGradBndryElemAlg<AlgTraits,VectorFieldType, GenericFieldType>;

}  // nalu
}  // sierra


#endif /* NDOTVGRADBNDRYELEMALG_H */

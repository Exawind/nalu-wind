...
#ifndef WALLDISTGRADEDGEALG_H
#define WALLDISTGRADEDGEALG_H
...
class WallDistGradEdgeAlg : public Algorithm
{
  static_assert(
...
public:
  ...
  virtual ~WallDistGradEdgeAlg() = default;
...
using ScalarWallDistGradEdgeAlg =
  WallDistGradEdgeAlg<ScalarFieldType, VectorFieldType>;
using VectorWallDistGradEdgeAlg =
  WallDistGradEdgeAlg<VectorFieldType, GenericFieldType>;

}  // nalu
}  // sierra


#endif /* WALLDISTGRADEDGEALG_H */

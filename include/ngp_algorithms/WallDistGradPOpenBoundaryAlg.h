...
#ifndef WALLDISTGRADPOPENBOUNDARYALG_H
#define WALLDISTGRADPOPENBOUNDARYALG_H
...
class WallDistGradPOpenBoundary : public Algorithm
{
public:
  WallDistGradPOpenBoundary(
    Realm &,
    stk::mesh::Part *,
    const bool useShifted);

  virtual ~WallDistGradPOpenBoundary() = default;

...
void test_metric_for_topo_2D(stk::topology topo, double tol) {
  ...
  sierra::nalu::EigenDecomposition::sym_diagonalize<double>(gij_exact_pt,
                                                            mij_ev, mij_evals);
...
TEST(MijTensorNGP, hex27) {
  ...
  Kokkos::View<double ***> mij_tensor("mij_tensor", 216, dim, dim);
  ...
  sierra::nalu::generic_Mij_3d<sierra::nalu::AlgTraitsHex27>(refGrad, v_coords,
                                                             mij_tensor);

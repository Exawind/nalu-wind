...
do_the_test()
{
  ...
  Kokkos::View<unsigned*, sierra::kynema_ugf::MemSpace> ngpResults("ngpResults", 1);
  Kokkos::View<unsigned*, sierra::kynema_ugf::MemSpace>::HostMirror hostResults =
  ...
  Kokkos::parallel_for(
    team_exec, KOKKOS_LAMBDA(const sierra::kynema_ugf::DeviceTeamHandleType& team) {
      unsigned one = 1;
      sierra::kynema_ugf::SharedMemView<double*, sierra::kynema_ugf::DeviceShmem> view1 =
        sierra::kynema_ugf::get_shmem_view_1D<
      ...
      sierra::kynema_ugf::SharedMemView<double*, sierra::kynema_ugf::DeviceShmem> view2 =
        sierra::kynema_ugf::get_shmem_view_1D<
          double, sierra::kynema_ugf::DeviceTeamHandleType,
          sierra::kynema_ugf::DeviceShmem>(team, numScalars);
      ...
      sierra::kynema_ugf::SharedMemView<double*, sierra::kynema_ugf::DeviceShmem> view3 =
        sierra::kynema_ugf::get_shmem_view_1D<
          double, sierra::kynema_ugf::DeviceTeamHandleType,
          sierra::kynema_ugf::DeviceShmem>(team, numScalars);

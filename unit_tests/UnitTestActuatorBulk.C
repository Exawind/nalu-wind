...
TEST(ActuatorMeta, constructor){
 ...
 EXPECT_EQ(0, fieldMeta.total_num_points(0));
 EXPECT_EQ(0, fieldMeta.total_num_points(1));
}
...
TEST(ActuatorMeta, addTurbine){
  ...
  EXPECT_EQ(1024, fieldMeta.total_num_points(0));
}
...
TEST(ActuatorMeta, copyCtor){
  ...
  EXPECT_EQ(30, fieldMeta.total_num_points(0));
  EXPECT_EQ(24, fieldMeta.total_num_points(1));

  ActuatorMeta fieldMeta2(fieldMeta);
  EXPECT_EQ(30, fieldMeta2.total_num_points(0));
  EXPECT_EQ(24, fieldMeta2.total_num_points(1));

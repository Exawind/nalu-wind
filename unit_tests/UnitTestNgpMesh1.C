  ...
  GenericFieldType* massFlowRate)
{
  ...
  auto ngpVelocity = fieldManager.get_device_smart_field
    <double, tags::READ_WRITE>("velocity");
  auto ngpMassFlowRate = fieldManager.get_device_smart_field
    <double, tags::READ_WRITE>("mass_flow_rate");
  ...
  auto flowRateData = fieldManager.get_legacy_smart_field
    <sierra::nalu::ScalarFieldType, tags::READ>("mass_flow_rate");
  auto velocityData = fieldManager.get_legacy_smart_field
    <sierra::nalu::VectorFieldType, tags::READ>("velocity");

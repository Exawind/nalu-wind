...
TEST_F(SSTKernelHex8Mesh, NGP_tke_sst_node)
{
  ...
  helperObjs.nodeAlg->add_kernel<sierra::kynema-ugf::TKESSTNodeKernel>(*meta_);
...
TEST_F(SSTKernelHex8Mesh, NGP_tke_sst_sust_node)
{
  ...
  sierra::kynema-ugf::Realm& realm = helperObjs.realm;
  realm.solutionOptions_->turbModelConstantMap_[sierra::kynema-ugf::TM_tkeAmb] = 5.0;
  realm.solutionOptions_->turbModelConstantMap_[sierra::kynema-ugf::TM_sdrAmb] = 50.0;
...
TEST_F(SSTKernelHex8Mesh, NGP_tke_sstlr_node)
{
  ...
  helperObjs.nodeAlg->add_kernel<sierra::kynema-ugf::TKESSTLRNodeKernel>(*meta_);
...
TEST_F(SSTKernelHex8Mesh, NGP_tke_sst_des_node)
{
  ...
  helperObjs.nodeAlg->add_kernel<sierra::kynema-ugf::TKESSTDESNodeKernel>(*meta_);
...
TEST_F(SSTKernelHex8Mesh, NGP_tke_sst_iddes_node)
{
  ...
  helperObjs.nodeAlg->add_kernel<sierra::kynema-ugf::TKESSTIDDESNodeKernel>(*meta_);
...
TEST_F(SSTKernelHex8Mesh, NGP_tke_sst_iddes_trans_node)
{
  ...
  helperObjs.nodeAlg->add_kernel<sierra::kynema-ugf::TKESSTIDDESBLTM2015NodeKernel>(
    *meta_);
...
TEST_F(SSTKernelHex8Mesh, NGP_tke_sst_trans_node)
{
  ...
  helperObjs.nodeAlg->add_kernel<sierra::kynema-ugf::TKESSTBLTM2015NodeKernel>(
    *meta_);
...
TEST_F(SSTKernelHex8Mesh, NGP_sdr_sst_node)
{
  ...
  helperObjs.nodeAlg->add_kernel<sierra::kynema-ugf::SDRSSTNodeKernel>(*meta_);
...
TEST_F(SSTKernelHex8Mesh, NGP_sdr_sstlr_node)
{
  ...
  helperObjs.nodeAlg->add_kernel<sierra::kynema-ugf::SDRSSTLRNodeKernel>(*meta_);
...
TEST_F(SSTKernelHex8Mesh, NGP_sdr_sst_des_node)
{
  ...
  helperObjs.nodeAlg->add_kernel<sierra::kynema-ugf::SDRSSTDESNodeKernel>(*meta_);
...
TEST_F(SSTKernelHex8Mesh, NGP_sdr_sst_trans_node)
{
  ...
  helperObjs.nodeAlg->add_kernel<sierra::kynema-ugf::SDRSSTBLTM2015NodeKernel>(
    *meta_);

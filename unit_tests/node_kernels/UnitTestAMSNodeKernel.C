...
TEST_F(AMSKernelHex8Mesh, NGP_tke_ams_node)
{
  ...
  helperObjs.nodeAlg->add_kernel<sierra::kynema-ugf::TKESSTAMSNodeKernel>(
...
TEST_F(AMSKernelHex8Mesh, NGP_sdr_ams_node)
{
  ...
  helperObjs.nodeAlg->add_kernel<sierra::kynema-ugf::SDRSSTAMSNodeKernel>(
    *meta_, solnOpts_.get_coordinates_name());
...
TEST_F(AMSKernelHex8Mesh, NGP_ams_forcing)
{
  ...
  helperObjs.nodeAlg->add_kernel<sierra::kynema-ugf::MomentumSSTAMSForcingNodeKernel>(
    *bulk_, solnOpts_);

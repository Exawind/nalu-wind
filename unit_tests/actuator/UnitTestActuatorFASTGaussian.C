...
{
  sierra::kynema-ugf::Coordinates epsilon;
  ...
  double r1 = sierra::kynema-ugf::actuator_utils::Gaussian_projection(
    nDim, distance.data(), epsilon);

  double r2 = sierra::kynema-ugf::actuator_utils::Gaussian_projection(

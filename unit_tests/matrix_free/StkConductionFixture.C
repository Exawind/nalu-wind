...
ConductionFixture::ConductionFixture(int nx, double scale)
  : bulkPtr(
    ...
    q_field(meta.declare_field<double>(
      ...
      sierra::kynema-ugf::matrix_free::conduction_info::q_name,
      3)),
    qbc_field(meta.declare_field<double>(
      stk::topology::NODE_RANK,
      sierra::kynema-ugf::matrix_free::conduction_info::qbc_name)),
    flux_field(meta.declare_field<double>(
      stk::topology::NODE_RANK,
      sierra::kynema-ugf::matrix_free::conduction_info::flux_name)),
    qtmp_field(meta.declare_field<double>(
      stk::topology::NODE_RANK,
      sierra::kynema-ugf::matrix_free::conduction_info::qtmp_name)),
    alpha_field(meta.declare_field<double>(
      stk::topology::NODE_RANK,
      sierra::kynema-ugf::matrix_free::conduction_info::volume_weight_name)),
    lambda_field(meta.declare_field<double>(
      stk::topology::NODE_RANK,
      sierra::kynema-ugf::matrix_free::conduction_info::diffusion_weight_name)),
    gid_field(meta.declare_field<typename Tpetra::Map<>::global_ordinal_type>(
      stk::topology::NODE_RANK,
      sierra::kynema-ugf::matrix_free::conduction_info::gid_name))
{
  ...
  sierra::kynema-ugf::matrix_free::populate_global_id_field(

...
public:
  ...
  fill_mesh_and_init_fields(const std::string& meshSpec = "generated:2x2x2")
  {
    ...
    coordField = static_cast<const sierra::kynema-ugf::VectorFieldType*>(
  ...
  const sierra::kynema-ugf::VectorFieldType* coordField{nullptr};
  sierra::kynema-ugf::ScalarFieldType* density{nullptr};
  sierra::kynema-ugf::ScalarFieldType* pressure{nullptr};
  sierra::kynema-ugf::VectorFieldType* velocity{nullptr};
  sierra::kynema-ugf::ScalarFieldType* mdotEdge{nullptr};
  sierra::kynema-ugf::GenericFieldType* massFlowRate{nullptr};
};

void
basic_node_loop(
  const stk::mesh::BulkData& bulk, sierra::kynema-ugf::ScalarFieldType& pressure)
{
  using Traits = sierra::kynema-ugf::kynema-ugf_ngp::NGPMeshTraits<stk::mesh::NgpMesh>;
  ...
  sierra::kynema-ugf::kynema-ugf_ngp::run_entity_algorithm(
  ...
  const stk::mesh::BulkData& bulk, sierra::kynema-ugf::ScalarFieldType& pressure)
{
  ...
  sierra::kynema-ugf::kynema-ugf_ngp::run_entity_par_reduce(
...
{
  using Traits = sierra::kynema-ugf::kynema-ugf_ngp::NGPMeshTraits<stk::mesh::NgpMesh>;
  using MinMaxSum = sierra::kynema-ugf::kynema-ugf_ngp::MinMaxSum<double>;
...
{
  using MeshIndex =
    sierra::kynema-ugf::kynema-ugf_ngp::NGPMeshTraits<stk::mesh::NgpMesh>::MeshIndex;
  const double presSet = 4.0;
  ...
  using value_type = Kokkos::Sum<sierra::kynema-ugf::kynema-ugf_ngp::ArrayDbl2>::value_type;
  value_type lsum;
  Kokkos::Sum<sierra::kynema-ugf::kynema-ugf_ngp::ArrayDbl2> sum_reducer(lsum);
...
basic_elem_loop(
  const stk::mesh::BulkData& bulk,
  sierra::kynema-ugf::ScalarFieldType& pressure,
  sierra::kynema-ugf::GenericFieldType& massFlowRate)
{
  ...
  sierra::kynema-ugf::kynema-ugf_ngp::run_elem_algorithm(
    "unittest_basic_elem_loop", ngpMesh, stk::topology::ELEMENT_RANK, sel,
    KOKKOS_LAMBDA(
      const sierra::kynema-ugf::kynema-ugf_ngp::EntityInfo<stk::mesh::NgpMesh>& einfo) {
...
basic_edge_loop(
  const stk::mesh::BulkData& bulk,
  sierra::kynema-ugf::ScalarFieldType& pressure,
  sierra::kynema-ugf::ScalarFieldType& mdotEdge)
{
  const double flowRate = 4.0;
  const double presSet = 10.0;
  ...
  sierra::kynema-ugf::kynema-ugf_ngp::run_edge_algorithm(
...
{
  using Traits = sierra::kynema-ugf::kynema-ugf_ngp::NGPMeshTraits<stk::mesh::NgpMesh>;
  using Hex8Traits = sierra::kynema-ugf::AlgTraitsHex8;
  using ElemSimdData = sierra::kynema-ugf::kynema-ugf_ngp::ElemSimdData<stk::mesh::NgpMesh>;
  typedef Kokkos::DualView<
    double*, Kokkos::LayoutRight, sierra::kynema-ugf::DeviceSpace>
    DoubleTypeView;

  const auto& meta = bulk.mesh_meta_data();
  sierra::kynema-ugf::ElemDataRequests dataReq(meta);
  auto meSCV =
  ...
  dataReq.add_master_element_call(
    sierra::kynema-ugf::SCV_SHIFTED_SHAPE_FCN, sierra::kynema-ugf::CURRENT_COORDINATES);

  sierra::kynema-ugf::kynema-ugf_ngp::MeshInfo<> meshInfo(bulk);
  stk::mesh::Selector sel = meta.universal_part();
  ...
  const auto ngpVelOp =
    sierra::kynema-ugf::kynema-ugf_ngp::simd_elem_nodal_field_updater(ngpMesh, ngpVel);
  ...
  sierra::kynema-ugf::kynema-ugf_ngp::run_elem_algorithm(
    ...
    dataReq, sel, KOKKOS_LAMBDA(ElemSimdData & edata) {
      ...
      auto& scv_vol =
        scrViews.get_me_views(sierra::kynema-ugf::CURRENT_COORDINATES).scv_volume;
  ...
  sierra::kynema-ugf::GenericFieldType& massFlowRate)
{
  ...
  dataReq.add_master_element_call(
    sierra::kynema-ugf::SCS_SHIFTED_SHAPE_FCN, sierra::kynema-ugf::CURRENT_COORDINATES);
  ...
  const auto mdotOps =
    sierra::kynema-ugf::kynema-ugf_ngp::simd_elem_field_updater(ngpMesh, ngpMdot);

  auto v_shape_fcn = sierra::kynema-ugf::shape_fcn<
    sierra::kynema-ugf::AlgTraitsHex8, sierra::kynema-ugf::QuadRank::SCS>(
    sierra::kynema-ugf::use_shifted_quad(true));
  ...
  sierra::kynema-ugf::kynema-ugf_ngp::run_elem_algorithm(
    ...
    sel, KOKKOS_LAMBDA(ElemSimdData & edata) {
      ...
      auto& v_vel = scrViews.get_scratch_view_2D(velID);
      auto& meViews = scrViews.get_me_views(sierra::kynema-ugf::CURRENT_COORDINATES);
...
basic_face_elem_loop(
  ...
  const sierra::kynema-ugf::GenericFieldType& exposedArea,
  sierra::kynema-ugf::ScalarFieldType& wallArea,
  sierra::kynema-ugf::ScalarFieldType& wallNormDist)
{
  using MeshIndex =
    sierra::kynema-ugf::kynema-ugf_ngp::NGPMeshTraits<stk::mesh::NgpMesh>::MeshIndex;
  using FaceTraits = sierra::kynema-ugf::AlgTraitsQuad4Hex8;
  using FaceSimdData =
    sierra::kynema-ugf::kynema-ugf_ngp::FaceElemSimdData<stk::mesh::NgpMesh>;
  const auto& meta = bulk.mesh_meta_data();
  const int ndim = meta.spatial_dimension();

  sierra::kynema-ugf::ElemDataRequests faceData(meta);
  sierra::kynema-ugf::ElemDataRequests elemData(meta);
  auto meFC =
    sierra::kynema-ugf::MasterElementRepo::get_surface_master_element_on_dev(
  ...
  faceData.add_coordinates_field(
    coordField, ndim, sierra::kynema-ugf::CURRENT_COORDINATES);
  faceData.add_face_field(
    exposedArea, FaceTraits::numFaceIp_, FaceTraits::nDim_);
  faceData.add_master_element_call(
    sierra::kynema-ugf::FC_SHAPE_FCN, sierra::kynema-ugf::CURRENT_COORDINATES);
  ...
  const auto areaOps =
    sierra::kynema-ugf::kynema-ugf_ngp::simd_face_elem_nodal_field_updater(ngpMesh, wArea);
  const auto distOps =
    sierra::kynema-ugf::kynema-ugf_ngp::simd_face_elem_nodal_field_updater(ngpMesh, wDist);

  sierra::kynema-ugf::kynema-ugf_ngp::run_face_elem_algorithm(
  ...
  const stk::mesh::BulkData& bulk, sierra::kynema-ugf::ScalarFieldType& pressure)
{
  ...
  sierra::kynema-ugf::kynema-ugf_ngp::run_elem_par_reduce(
...

  {
    ...
    double pSumCalc = 0.0;
    for (int i = 0; i < sierra::kynema-ugf::simdLen; ++i)
  ...
  const sierra::kynema-ugf::GenericFieldType& exposedArea)
{
  ...
  sierra::kynema-ugf::kynema-ugf_ngp::run_face_elem_par_reduce(
...
TEST_F(NgpLoopTest, NGP_basic_face_elem_loop)
{
  ...
  stk::mesh::put_field_on_mesh(
    ...
    meta->spatial_dimension() * sierra::kynema-ugf::AlgTraitsQuad4::numScsIp_,
    nullptr);
  ...
  unit_test_kernel_utils::calc_exposed_area_vec(
    *bulk, sierra::kynema-ugf::AlgTraitsQuad4::topo_, *coordField, exposedAreaVec);

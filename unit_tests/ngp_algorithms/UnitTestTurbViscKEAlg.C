...
TEST_F(KEKernelHex8Mesh, NGP_turb_visc_ke_alg)
{
...

  {
    std::vector<double> expectedValues = {
      0.0040927529208101276,
      0.004756620887334956,
      0.0047455106720311118,
      0.0042834431659046351,
      0.0024056598081291371,
      0.0027958716083218245,
      0.0016322044534763486,
      0.0017904108086812805,
    };

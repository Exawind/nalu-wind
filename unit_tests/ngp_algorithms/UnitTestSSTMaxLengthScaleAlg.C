...
TEST_F(SSTKernelHex8Mesh, NGP_SST_Max_Length_Scale)
{
  ...
  sierra::kynema-ugf::SSTMaxLengthScaleDriver AlgDriver(helperObjs.realm);

  AlgDriver.register_elem_algorithm<sierra::kynema-ugf::SSTMaxLengthScaleAlg>(
    sierra::kynema-ugf::INTERIOR, partVec_[0], "SSTMaxLen");

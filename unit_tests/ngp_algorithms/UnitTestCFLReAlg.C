...
TEST_F(MomentumKernelHex8Mesh, NGP_courant_reynolds)
{
  ...
  sierra::kynema-ugf::CourantReAlgDriver algDriver(helperObjs.realm);
  algDriver.register_elem_algorithm<sierra::kynema-ugf::CourantReAlg>(
    sierra::kynema-ugf::INTERIOR, partVec_[0], "courant_reynolds", algDriver);

...
TEST(TestEigen, testeigendecomp3d)
{
  ...
  sierra::kynema-ugf::EigenDecomposition::sym_diagonalize(A3d_fixed, Q_, D_);
...
TEST(TestEigen, testeigendecomp2d)
{
  ...
  sierra::kynema-ugf::EigenDecomposition::sym_diagonalize(A2d_fixed, Q_, D_);
...
TEST(TestEigen, testeigendecompandreconstruct3d)
{
  ...
  sierra::kynema-ugf::EigenDecomposition::sym_diagonalize(A3d_rand, Q_, D_);
  sierra::kynema-ugf::EigenDecomposition::reconstruct_matrix_from_decomposition(
    D_, Q_, b_);
...
TEST(TestEigen, testeigendecompandreconstruct2d)
{
  ...
  sierra::kynema-ugf::EigenDecomposition::sym_diagonalize(A2d_rand, Q_, D_);
  sierra::kynema-ugf::EigenDecomposition::reconstruct_matrix_from_decomposition(
    D_, Q_, b_);
...
TEST(TestEigen, testeigendecomp3d_simd)
{
  ...
  sierra::kynema-ugf::EigenDecomposition::sym_diagonalize(A3d_fixed_simd, Q_, D_);
...
TEST(TestEigen, testeigendecomp2d_simd)
{
  ...
  sierra::kynema-ugf::EigenDecomposition::sym_diagonalize(A2d_fixed_simd, Q_, D_);
...
TEST(TestEigen, testeigendecompandreconstruct3d_simd)
{
  ...
  sierra::kynema-ugf::EigenDecomposition::sym_diagonalize(A3d_rand_simd, Q_, D_);
  sierra::kynema-ugf::EigenDecomposition::reconstruct_matrix_from_decomposition(
    D_, Q_, b_);
...
TEST(TestEigen, testeigendecompandreconstruct2d_simd)
{
  ...
  sierra::kynema-ugf::EigenDecomposition::sym_diagonalize(A2d_rand_simd, Q_, D_);
  sierra::kynema-ugf::EigenDecomposition::reconstruct_matrix_from_decomposition(
    D_, Q_, b_);

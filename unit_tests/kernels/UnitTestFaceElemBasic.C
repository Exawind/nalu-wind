...
public:
  ...
  void execute(
    sierra::kynema-ugf::ScratchViews<
      ...
      sierra::kynema-ugf::DeviceShmem>& faceViews,
    sierra::kynema-ugf::ScratchViews<
      DoubleType,
      sierra::kynema-ugf::DeviceTeamHandleType,
      sierra::kynema-ugf::DeviceShmem>& elemViews,
    int numSimdFaces,
  ...
  Kokkos::DualView<int*, Kokkos::LayoutRight, sierra::kynema-ugf::DeviceSpace>
    result_;
};
...
do_assemble_face_elem_solver_test(
  ...
  sierra::kynema-ugf::AssembleFaceElemSolverAlgorithm& faceElemAlg,
  IdFieldType* idField)
{
  ...
  faceElemAlg.run_face_elem_algorithm(
    bulk, KOKKOS_LAMBDA(
            sierra::kynema-ugf::SharedMemData_FaceElem<
              sierra::kynema-ugf::DeviceTeamHandleType, sierra::kynema-ugf::DeviceShmem> &
            smdata) {
...
TEST_F(Hex8Mesh, NGP_faceElemBasic)
{
  ...
  sierra::kynema-ugf::MasterElement* meFC =
    sierra::kynema-ugf::MasterElementRepo::get_surface_master_element_on_dev(
      sierra::kynema-ugf::AlgTraitsQuad4::topo_);
...
TEST_F(Hex8ElementWithBCFields, faceElemMomentumSymmetry)
{
  ...
  sierra::kynema-ugf::SolutionOptions solnOptions;

  stk::topology faceTopo = stk::topology::QUAD_4;
  stk::topology elemTopo = stk::topology::HEX_8;
  stk::mesh::Part* surface1 = meta->get_part("all_surfaces");
  unit_test_utils::HelperObjects helperObjs(
    bulk, elemTopo, sierra::kynema-ugf::AlgTraitsQuad4Hex8::nDim_, surface1);
  ...
  auto momentumSymmetryElemKernel =
    new sierra::kynema-ugf::MomentumSymmetryElemKernel<
      sierra::kynema-ugf::AlgTraitsQuad4Hex8>(
...
TEST_F(Hex8ElementWithBCFields, faceElemMomentumOpen)
{
  ...
  auto momentumOpenAdvDiffElemKernel =
    new sierra::kynema-ugf::MomentumOpenAdvDiffElemKernel<
      sierra::kynema-ugf::AlgTraitsQuad4Hex8>(
...
TEST_F(Hex8ElementWithBCFields, faceElemScalarOpen)
{
  ...
  auto scalarOpenAdvElemKernel =
    new sierra::kynema-ugf::ScalarOpenAdvElemKernel<sierra::kynema-ugf::AlgTraitsQuad4Hex8>(

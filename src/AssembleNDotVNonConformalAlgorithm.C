...
#include "AssembleNDotVNonConformalAlgorithm.h"
...
AssembleNDotVNonConformalAlgorithm::AssembleNDotVNonConformalAlgorithm(
  Realm& realm,
  stk::mesh::Part* part,
...
void
AssembleNDotVNonConformalAlgorithm::initialize_connectivity()
{
  eqSystem_->linsys_->buildNonConformalNodeGraph(partVec_);
}

void
AssembleNDotVNonConformalAlgorithm::execute()
{

...
TiogaBlock::setup(stk::mesh::PartVector& bcPartVec)
{
  ...
  sierra::kynema-ugf::ScalarIntFieldType& ibcell =
    meta_.declare_field<int>(stk::topology::ELEM_RANK, "iblank_cell");

  sierra::kynema-ugf::ScalarFieldType& nVol =
...
TiogaBlock::update_coords()
{
  ...
  sierra::kynema-ugf::ScalarFieldType* nodeVol =
...
TiogaBlock::update_element_volumes()
{
  ...
  sierra::kynema-ugf::ScalarFieldType* elemVolume =
...
void
TiogaBlock::register_solution(
  TIOGA::tioga& tg, const sierra::kynema-ugf::OversetFieldData& field)
{
  if (num_nodes_ < 1)
    return;
...
void
TiogaBlock::update_solution(const sierra::kynema-ugf::OversetFieldData& field)
{
  if (num_nodes_ < 1)
    return;

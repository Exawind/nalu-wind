...
AMSAlgDriver::initial_work()
{
  ...
  if (resetAMSAverages_) {
    ...
    kynema-ugf_ngp::field_copy(ngpMesh, sel, avgU, U, nDim);
    ...
    kynema-ugf_ngp::field_copy(ngpMesh, sel, avgDudx, dudx, nDim * nDim);
  }
}
...
AMSAlgDriver::predict_state()
{
  ...
  kynema-ugf_ngp::field_copy(ngpMesh, sel, avgProdNp1, avgProdN, 1);
  kynema-ugf_ngp::field_copy(ngpMesh, sel, avgTkeResNp1, avgTkeResN, 1);
  kynema-ugf_ngp::field_copy(ngpMesh, sel, avgResAdeqNp1, avgResAdeqN, 1);

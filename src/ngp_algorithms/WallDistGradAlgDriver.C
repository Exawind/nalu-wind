...
WallDistGradAlgDriver<GradPhiType>::WallDistGradAlgDriver(
  Realm& realm,
...
template<typename GradPhiType>
void WallDistGradAlgDriver<GradPhiType>::pre_work()
{
...
template<typename GradPhiType>
void WallDistGradAlgDriver<GradPhiType>::post_work()
{
...
template class WallDistGradAlgDriver<GenericFieldType>;

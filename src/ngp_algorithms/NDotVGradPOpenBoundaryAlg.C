...
#include "ngp_algorithms/NDotVGradPOpenBoundaryAlg.h"
#include "Algorithm.h"
...
// Class Definition
//==========================================================================
// NDotVGradPOpenBoundary - adds in boundary contribution
...
NDotVGradPOpenBoundary<AlgTraits>::NDotVGradPOpenBoundary(
  Realm &realm,
  stk::mesh::Part *part,
...
template <typename AlgTraits>
void
NDotVGradPOpenBoundary<AlgTraits>::execute()
{
  ...
  const std::string algName = "NDotVGradPOpenBoundary_" +
...
INSTANTIATE_KERNEL_FACE_ELEMENT(NDotVGradPOpenBoundary)

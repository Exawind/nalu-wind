...
SDRWallFuncAlgDriver::pre_work()
{
  ...
  auto& bcsdr =
    kynema-ugf_ngp::get_ngp_field(realm_.mesh_info(), "wall_model_sdr_bc");
  auto& wallArea =
    kynema-ugf_ngp::get_ngp_field(realm_.mesh_info(), "assembled_wall_area_sdr");
...
SDRWallFuncAlgDriver::post_work()
{
  ...
  auto& wallArea =
    kynema-ugf_ngp::get_ngp_field(realm_.mesh_info(), "assembled_wall_area_sdr");
  auto& sdr =
    kynema-ugf_ngp::get_ngp_field(realm_.mesh_info(), "specific_dissipation_rate");
  auto& sdrWallBC = kynema-ugf_ngp::get_ngp_field(realm_.mesh_info(), "sdr_bc");

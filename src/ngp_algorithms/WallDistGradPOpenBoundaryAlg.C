...
#include "ngp_algorithms/WallDistGradPOpenBoundaryAlg.h"
#include "Algorithm.h"
...
// Class Definition
//==========================================================================
// WallDistGradPOpenBoundary - adds in boundary contribution
...
WallDistGradPOpenBoundary<AlgTraits>::WallDistGradPOpenBoundary(
  Realm &realm,
  stk::mesh::Part *part,
...
template <typename AlgTraits>
void
WallDistGradPOpenBoundary<AlgTraits>::execute()
{
  ...
  const std::string algName = "WallDistGradPOpenBoundary_" +
...
INSTANTIATE_KERNEL_FACE_ELEMENT(WallDistGradPOpenBoundary)

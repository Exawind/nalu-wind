...
NDotVGradAlgDriver<GradPhiType>::NDotVGradAlgDriver(
  Realm& realm,
...
template<typename GradPhiType>
void NDotVGradAlgDriver<GradPhiType>::pre_work()
{
...
template<typename GradPhiType>
void NDotVGradAlgDriver<GradPhiType>::post_work()
{
...
template class NDotVGradAlgDriver<GenericFieldType>;

...
NDotVGradBndryElemAlg<AlgTraits, PhiType, GradPhiType>::NDotVGradBndryElemAlg(
  Realm& realm,
  stk::mesh::Part* part,
  PhiType* phi,
  GradPhiType* gradPhi,
...
template <typename AlgTraits, typename PhiType, typename GradPhiType>
void NDotVGradBndryElemAlg<AlgTraits, PhiType, GradPhiType>::execute()
{
...
#define INSTANTIATE_ALG(AlgTraits)                                             \
  template class NDotVGradBndryElemAlg<                                        \

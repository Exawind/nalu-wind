...
WallDistGradElemAlg<AlgTraits, PhiType, GradPhiType>::WallDistGradElemAlg(
  Realm& realm,
  stk::mesh::Part* part,
  PhiType* phi,
  GradPhiType* gradPhi,
...
template <typename AlgTraits, typename PhiType, typename GradPhiType>
void WallDistGradElemAlg<AlgTraits, PhiType, GradPhiType>::execute()
{
...
#define INSTANTIATE_ALG(AlgTraits)                                             \
  template class WallDistGradElemAlg<                                             \
    AlgTraits, ScalarFieldType, VectorFieldType>;                              \
  template class WallDistGradElemAlg<AlgTraits, VectorFieldType, GenericFieldType>

...
WallDistGradBndryElemAlg<AlgTraits, PhiType, GradPhiType>::WallDistGradBndryElemAlg(
  Realm& realm,
  stk::mesh::Part* part,
  PhiType* phi,
  GradPhiType* gradPhi,
...
template <typename AlgTraits, typename PhiType, typename GradPhiType>
void WallDistGradBndryElemAlg<AlgTraits, PhiType, GradPhiType>::execute()
{
...
#define INSTANTIATE_ALG(AlgTraits)                                             \
  template class WallDistGradBndryElemAlg<                                        \

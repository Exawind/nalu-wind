...
NDotVGradEdgeAlg<PhiType, GradPhiType>::NDotVGradEdgeAlg(
  Realm& realm,
  stk::mesh::Part* part,
  PhiType* phi,
  GradPhiType* gradPhi)
...
template <typename PhiType, typename GradPhiType>
void NDotVGradEdgeAlg<PhiType, GradPhiType>::execute()
{
...
template class NDotVGradEdgeAlg<ScalarFieldType, VectorFieldType>;
template class NDotVGradEdgeAlg<VectorFieldType, GenericFieldType>;

...
WallDistGradEdgeAlg<PhiType, GradPhiType>::WallDistGradEdgeAlg(
  Realm& realm,
  stk::mesh::Part* part,
  PhiType* phi,
  GradPhiType* gradPhi)
...
template <typename PhiType, typename GradPhiType>
void WallDistGradEdgeAlg<PhiType, GradPhiType>::execute()
{
...
template class WallDistGradEdgeAlg<ScalarFieldType, VectorFieldType>;
template class WallDistGradEdgeAlg<VectorFieldType, GenericFieldType>;

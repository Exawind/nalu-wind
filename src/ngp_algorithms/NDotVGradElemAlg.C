...
NDotVGradElemAlg<AlgTraits, PhiType, GradPhiType>::NDotVGradElemAlg(
  Realm& realm,
  stk::mesh::Part* part,
  PhiType* phi,
  GradPhiType* gradPhi,
...
template <typename AlgTraits, typename PhiType, typename GradPhiType>
void NDotVGradElemAlg<AlgTraits, PhiType, GradPhiType>::execute()
{
...
#define INSTANTIATE_ALG(AlgTraits)                                             \
  template class NDotVGradElemAlg<                                             \
    AlgTraits, ScalarFieldType, VectorFieldType>;                              \
  template class NDotVGradElemAlg<AlgTraits, VectorFieldType, GenericFieldType>

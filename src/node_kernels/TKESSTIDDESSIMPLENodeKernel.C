...
TKESSTIDDESSIMPLENodeKernel::TKESSTIDDESSIMPLENodeKernel(
  const stk::mesh::MetaData& meta)
  : NGPNodeKernel<TKESSTIDDESSIMPLENodeKernel>(),
...
void
TKESSTIDDESSIMPLENodeKernel::setup(Realm& realm)
{
...
KOKKOS_FUNCTION
void
TKESSTIDDESSIMPLENodeKernel::execute(

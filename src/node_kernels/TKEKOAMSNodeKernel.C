...
TKEKOAMSNodeKernel::TKEKOAMSNodeKernel(const stk::mesh::MetaData& meta)
  : NGPNodeKernel<TKEKOAMSNodeKernel>(),
...
void
TKEKOAMSNodeKernel::setup(Realm& realm)
{

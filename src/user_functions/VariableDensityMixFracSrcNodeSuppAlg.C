  ...
  double* /*lhs*/, double* rhs, stk::mesh::Entity node)
{
  ...
  const double src =
    ...
    0.10e1 /
      ...
      sin(a_ * pi_ * z) * znot_ * cos(amf_ * pi_ * x) * cos(amf_ * pi_ * y) *
      cos(amf_ * pi_ * z) +
    0.10e1 /
      (znot_ * cos(amf_ * pi_ * x) * cos(amf_ * pi_ * y) * cos(amf_ * pi_ * z) /
         rhoP_ +
    ...
    0.10e1 /
      ...
      pi_ * znot_ * cos(amf_ * pi_ * x) * cos(amf_ * pi_ * y) *
      cos(amf_ * pi_ * z) +
    0.10e1 /
      (znot_ * cos(amf_ * pi_ * x) * cos(amf_ * pi_ * y) * cos(amf_ * pi_ * z) /
         rhoP_ +
      ...
      znot_ * cos(amf_ * pi_ * x) * cos(amf_ * pi_ * y) * sin(amf_ * pi_ * z) *
      amf_ * pi_ +
    0.3e1 * visc_ / Sc_ * znot_ * cos(amf_ * pi_ * x) * amf_ * amf_ * pi_ *
      pi_ * cos(amf_ * pi_ * y) * cos(amf_ * pi_ * z);

...
VariableDensityContinuityMMSHOElemKernel<AlgTraits>::VariableDensityContinuityMMSHOElemKernel(
...
//--------------------------------------------------------------------------
template <class AlgTraits>
void VariableDensityContinuityMMSHOElemKernel<AlgTraits>::setup(const TimeIntegrator& ti)
{
  projTimeScale_ = ti.get_time_step() / ti.get_gamma1();
}
//--------------------------------------------------------------------------
template<class AlgTraits>
void
VariableDensityContinuityMMSHOElemKernel<AlgTraits>::execute(
  ...
  ScratchViewsHO<DoubleType>& scratchViews)
{
  ...
  const auto inv_projTimeScale = 1.0 / projTimeScale_;

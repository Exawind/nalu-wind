...
MeshVelocityEdgeAlg<AlgTraits>::MeshVelocityEdgeAlg(
  ...
  stk::mesh::Part* part
    ...
    edgeSweptVolumeNp1_(
      get_field_ordinal(
        realm.meta_data(), "edge_swept_face_volume", stk::mesh::StateNP1, stk::topology::EDGE_RANK)),
    edgeSweptVolumeN_(
      get_field_ordinal(
        realm.meta_data(), "edge_swept_face_volume", stk::mesh::StateN, stk::topology::EDGE_RANK)),
...
template<typename AlgTraits>
void MeshVelocityEdgeAlg<AlgTraits>::execute()
{

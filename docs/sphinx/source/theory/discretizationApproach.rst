...
Kynema-UGF supports two discretizations: control volume finite element and
...
projected nodal gradient (see the Kynema-UGF theory manual or a variety of
...
Kynema-UGF, the above form of equation is used.
